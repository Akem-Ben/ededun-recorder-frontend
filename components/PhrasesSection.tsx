...
const PhrasesSection: React.FC<any> = ({ setActiveView, activeView }: { setActiveView: any, activeView: any }) => {
      ...
      <div className="max-w-4xl mx-auto px-2 sm:px-4">
        <div className="flex flex-col justify-center items-center mb-4 sm:mb-8">
          ...
          <span className="flex font-[400] text-[#012657] leading-[1.5] text-sm sm:text-lg justify-center items-center text-center">
            Select a phrase to record and contribute to the Èdèdún AI Powered Yorùbá Platform (APYP)
          </span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 gap-2 sm:gap-4">
          ...
          <div className="text-sm font-medium text-black w-full sm:w-auto sm:max-w-xs">
            ...
            <div className="text-sm">
              You are making incredible progress {Math.round(progress)}% out of 100%
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md mb-4">
            ...
            {phrasesLoading ? (
              ...
              <div className="space-y-2 max-h-80 overflow-y-auto pr-2">
                {unrecordedPhrases.map((phrase: any, index: any) => (
                  <motion.div
                    key={phrase.id}
                    className={`rounded-lg ${currentPhraseIndex === index
                  ...
                  >
                    <div className="p-3 rounded-lg border-r-4 border-[#1671D9]">
                      <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0">
                        ...
                        <div>
                          <Button backgroundColor="#1671D9" onClick={() => setCurrentPhraseIndex(index)}>
                            <div className="flex items-center gap-[5px] sm:gap-[10px]">
                              <div>
                                <svg width="14" height="20" viewBox="0 0 14 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M7 12.5C8.66 12.5 10 11.16 10 9.5V3.5C10 1.84 8.66 0.5 7 0.5C5.34 0.5 4 1.84 4 3.5V9.5C4 11.16 5.34 12.5 7 12.5Z" fill="white" />
                                  <path d="M12 9.5C12 12.26 9.76 14.5 7 14.5C4.24 14.5 2 12.26 2 9.5H0C0 13.03 2.61 15.93 6 16.42V19.5H8V16.42C11.39 15.93 14 13.03 14 9.5H12Z" fill="white" />
                                </svg>
                              </div>
                              <div className="text-sm sm:text-base">Start Recording</div>
                            </div>
                          </Button>
                        </div>
                      </div>
          ...
          {currentPhraseIndex === null && unrecordedPhrases.length > 9 && (
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <AudioRecorder
                ...
                onRecordingComplete={() =>
                  handleRecordingComplete(unrecordedPhrases[currentPhraseIndex].id)
                }
              />
            </motion.div>
          </AnimatePresence>
