  ...
  return (
    <div className="mx-auto px-16 max-w-full h-full flex flex-col">
      ...
      <div className="w-full">
        <h1
          className={
            "text-3xl lg:text-[50px] font-semibold mb-4 lg:mb-[50px] animate__animated animate__fadeInUp"
          }
        ...
        <p
          className="text-base lg:text-lg animate__animated animate__fadeInUp animate__delay-1s"
